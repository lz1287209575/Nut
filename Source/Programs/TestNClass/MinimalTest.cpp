...
public:
	...
	void ExampleFunction()
	{
		...
		std::cout << "IntProperty: " << ExampleIntProperty << ", FloatProperty: " << ExampleFloatProperty << std::endl;
...
int main()
{
	...
	for (const auto& className : allClasses)
	{
		...
		const NClassReflection* reflection = SimpleReflection::GetInstance().GetClassReflection(className);
