...
LUAI_FUNC void luaC_addmethod(lua_State *L, ClassDesc *cd, TString *name, 
                              TValue *func, lu_byte visibility, lu_byte modifiers);
LUAI_FUNC void luaC_addfield(lua_State *L, ClassDesc *cd, TString *name, 
                             TValue *value, lu_byte visibility);
LUAI_FUNC void luaC_addproperty(lua_State *L, ClassDesc *cd, TString *name,
...
LUAI_FUNC void luaC_addinterfacemethod(lua_State *L, InterfaceDesc *id, 
                                       TString *name, TValue *signature);

/* Namespace creation and management */
LUAI_FUNC NamespaceDesc *luaC_newnamespace(lua_State *L, TString *name, 
                                           NamespaceDesc *parent);
LUAI_FUNC void luaC_addnamespacemember(lua_State *L, NamespaceDesc *nd, 
...
LUAI_FUNC void luaC_setfield(lua_State *L, ClassInstance *inst, TString *name, 
                             TValue *value);
...
LUAI_FUNC ClassMember *luaC_findmember(ClassDesc *cd, TString *name, 
                                        lu_byte visibility);
LUAI_FUNC int luaC_checkvisibility(ClassDesc *cd, ClassMember *member, 
                                   ClassDesc *caller);
...
LUAI_FUNC const TValue *luaC_getclassmeta(lua_State *L, ClassDesc *cd, 
                                          TMS event);
LUAI_FUNC void luaC_callconstructor(lua_State *L, ClassInstance *inst, 
                                   int nargs);
