...
void NObject::operator delete(void* Ptr) noexcept {
    ...
    NLogger::Debug("NObject::delete releasing memory at " + 
                    std::to_string(reinterpret_cast<uintptr_t>(Ptr)));
...
void* NObject::operator new(size_t Size, std::align_val_t Alignment) {
    ...
    NLogger::Debug("NObject::new(aligned) allocated " + std::to_string(Size) + 
                    " bytes with alignment " + std::to_string(static_cast<size_t>(Alignment)) + 
                    " at " + std::to_string(reinterpret_cast<uintptr_t>(Ptr)));
    return Ptr;
}
...
void NObject::operator delete(void* Ptr, std::align_val_t Alignment) noexcept {
    ...
    NLogger::Debug("NObject::delete(aligned) releasing memory at " + 
                    std::to_string(reinterpret_cast<uintptr_t>(Ptr)) + 
